...
@section('content')
    <div class="flex justify-center">
        <div class="w-4/12 bg-white py-5 px-6 rounded-lg">
            <div class="text-bold text-xl text-center mb-3">
            ...
            <form action="{{ route('register') }}" method="post">
                ...
                <div class="mb-4">
                    ...
                    <input type="text" name="username" id="username" placeholder="Username" class= "bg-gray-100 border-2 w-full p-3 rounded-lg @error('username') border-red-500 @enderror" value="{{ old('username') }}">
                ...
                <div class="mb-4">
                    ...
                    <input type="password" name="password_confirmation" id="password_confirmation" placeholder="Repeat your password" class=" bg-gray-100 border-2 w-full p-3 rounded-lg @error('password_confirmation') border-red-500 @enderror" value="">
